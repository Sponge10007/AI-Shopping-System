...
TEST_SCRIPTS = [
    {
        "name": "商品创建接口测试",
        "file": "01_create_product_test.py",
        "result_file": "01_create_product_result.json"
    },
    {
        "name": "商品查询接口测试",
        "file": "02_query_product_test.py",
        "result_file": "02_query_product_result.json"
    },
    {
        "name": "商品更新/下架/补货接口测试",
        "file": "03_update_product_test.py",
        "result_file": "03_update_product_result.json"
    },
    {
        "name": "商品模块完整业务流程测试",
        "file": "04_product_flow_test.py",
        "result_file": "04_product_flow_result.json"
    }
]
...
def main():
    ...
    # ========== 模式1：跳过等待，直接测试 ==========
    if skip_env:
        print_banner("商品模块测试（跳过环境检测，直接测试）")
